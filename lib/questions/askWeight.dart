...
import 'package:gym_appfin/questions/currentGoal.dart';


class AskWeight extends StatefulWidget {
  const AskWeight({super.key});

  @override
  State<AskWeight> createState() => _AskWeightState();
}

class _AskWeightState extends State<AskWeight> {
  ...
  Future<void> _updateUserWeight() async {
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const currentGoal()),
      );
    } catch (e) {
      print('Error: $e');
